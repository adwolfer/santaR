...
test_that('default value, log likelihood of 4 fitted splines at 3 df', {
  ...
  # Check result value
  expect_equal(result_loglik1_df2, expected_loglik1_df2)
  expect_equal(result_loglik2_df2, expected_loglik2_df2)
  expect_equal(result_loglik3_df2, expected_loglik3_df2)
  expect_equal(result_loglik4_df2, expected_loglik4_df2)
  expect_equal(result_loglik1_df5, expected_loglik1_df5)
  expect_equal(result_loglik2_df5, expected_loglik2_df5)
  expect_equal(result_loglik3_df5, expected_loglik3_df5)
  expect_equal(result_loglik4_df5, expected_loglik4_df5)
  expect_equal(result_loglik1_df7, expected_loglik1_df7)
  expect_equal(result_loglik2_df7, expected_loglik2_df7)
  expect_equal(result_loglik3_df7, expected_loglik3_df7)
  expect_equal(result_loglik4_df7, expected_loglik4_df7)
})
