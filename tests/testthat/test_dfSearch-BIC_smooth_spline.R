...
test_that('default value, BIC of 4 fitted splines at 3 df', {
  ...
  # Check result value
  expect_equal(result_BIC1_df2, expected_BIC1_df2)
  expect_equal(result_BIC2_df2, expected_BIC2_df2)
  expect_equal(result_BIC3_df2, expected_BIC3_df2)
  expect_equal(result_BIC4_df2, expected_BIC4_df2)
  expect_equal(result_BIC1_df5, expected_BIC1_df5)
  expect_equal(result_BIC2_df5, expected_BIC2_df5)
  expect_equal(result_BIC3_df5, expected_BIC3_df5)
  expect_equal(result_BIC4_df5, expected_BIC4_df5)
  expect_equal(result_BIC1_df7, expected_BIC1_df7)
  expect_equal(result_BIC2_df7, expected_BIC2_df7)
  expect_equal(result_BIC3_df7, expected_BIC3_df7)
  expect_equal(result_BIC4_df7, expected_BIC4_df7)
})
