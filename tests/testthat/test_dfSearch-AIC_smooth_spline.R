...
test_that('default value, AIC of 4 fitted splines at 3 df', {
  ...
  # Check result value
  expect_equal(result_AIC1_df2, expected_AIC1_df2)
  expect_equal(result_AIC2_df2, expected_AIC2_df2)
  expect_equal(result_AIC3_df2, expected_AIC3_df2)
  expect_equal(result_AIC4_df2, expected_AIC4_df2)
  expect_equal(result_AIC1_df5, expected_AIC1_df5)
  expect_equal(result_AIC2_df5, expected_AIC2_df5)
  expect_equal(result_AIC3_df5, expected_AIC3_df5)
  expect_equal(result_AIC4_df5, expected_AIC4_df5)
  expect_equal(result_AIC1_df7, expected_AIC1_df7)
  expect_equal(result_AIC2_df7, expected_AIC2_df7)
  expect_equal(result_AIC3_df7, expected_AIC3_df7)
  expect_equal(result_AIC4_df7, expected_AIC4_df7)
})
