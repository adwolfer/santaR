...
test_that('default value, AICc of 4 fitted splines at 3 df', {
  ...
  # Check result value
  expect_equal(result_AICc1_df2, expected_AICc1_df2)
  expect_equal(result_AICc2_df2, expected_AICc2_df2)
  expect_equal(result_AICc3_df2, expected_AICc3_df2)
  expect_equal(result_AICc4_df2, expected_AICc4_df2)
  expect_equal(result_AICc1_df5, expected_AICc1_df5)
  expect_equal(result_AICc2_df5, expected_AICc2_df5)
  expect_equal(result_AICc3_df5, expected_AICc3_df5)
  expect_equal(result_AICc4_df5, expected_AICc4_df5)
  expect_equal(result_AICc1_df7, expected_AICc1_df7)
  expect_equal(result_AICc2_df7, expected_AICc2_df7)
  expect_equal(result_AICc3_df7, expected_AICc3_df7)
  expect_equal(result_AICc4_df7, expected_AICc4_df7)
})
